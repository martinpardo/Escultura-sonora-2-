/*
 * ============================================================================
 * INSTALACIÓN SONORA - 2 CANALES ESTÉREO (VERSIÓN CORREGIDA)
 ...
 * 
 * Circuito de filtro por canal:
 *   Pin PWM --- 1kΩ resistor ---+--- 100nF capacitor --- GND
 *                                |
...
void updateControl() {
  ...
  if (controlSilencios.ready()) {
    ...
    if (rand(1, 101) < 30) {
      ...
      if (sonando) {
        ...
        frecuenciaAgudos = rand(600, 3500);
        frecuenciaGraves = rand(60, 300);
        ...
        controlSilencios.start(rand(3000, 12000));
        duracionGolpe = 0;
        golpeActivo = false;
      }
    }
  ...
  oscAgudosArmonicos.setFreq(frecuenciaAgudos * 2.01); // Ligera desafinación
...
AudioOutput_t updateAudio() {
  ...
  // Escalamos de rango -128..127 a -32768..32767 para from16Bit
...
void setup() {
  ...
  oscAgudosArmonicos.setFreq(1760);
